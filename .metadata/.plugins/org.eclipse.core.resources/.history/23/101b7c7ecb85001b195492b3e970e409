...
public class TesteTipos {
	...
	public static void main(String[] args) {
		 ...
		 */
		    ...
		    double preço = Double.parseDouble(JOptionPane.showInputDialog("digite a preço"));
			int imposto = Integer.parseInt(JOptionPane.showInputDialog("Digite o imposto."));
			double total = preço / imposto + preço;
			
			System.out.printf
			("Modelo do notebook %s x %s preço com imposto: R$ %.2f", notebook, quantidade, total);
